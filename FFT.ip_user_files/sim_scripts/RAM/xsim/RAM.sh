...
#
# Generated by Vivado on Fri Nov 17 15:14:16 +0800 2017
...
# Script info
echo -e "RAM.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM xil_defaultlib.RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim RAM -key {Behavioral:sim_1:Functional:RAM} -tclbatch cmd.tcl -log simulate.log
}
