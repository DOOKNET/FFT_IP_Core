...
#
# Generated by Vivado on Tue Oct 17 18:34:48 +0800 2017
...
# Script info
echo -e "ROM.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM xil_defaultlib.ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ROM -key {Behavioral:sim_1:Functional:ROM} -tclbatch cmd.tcl -log simulate.log
}
