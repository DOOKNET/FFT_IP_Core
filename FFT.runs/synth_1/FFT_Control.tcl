...
read_verilog -library xil_defaultlib E:/Workspace/Vivado_16.4/2017_11_5_FFT/Design/Code/FFT_Control.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top FFT_Control -part xc7a35tftg256-1


write_checkpoint -force -noxdef FFT_Control.dcp

catch { report_utilization -file FFT_Control_utilization_synth.rpt -pb FFT_Control_utilization_synth.pb }
